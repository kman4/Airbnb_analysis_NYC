...
ALTER TABLE "rates_monthly" ADD CONSTRAINT "fk_rates_monthly_id" FOREIGN KEY("id")
REFERENCES "listing_master" ("id");

ALTER TABLE "rates_weekOfDay" ADD CONSTRAINT "fk_rates_weekOfDay_id" FOREIGN KEY("id")
REFERENCES "listing_master" ("id");
